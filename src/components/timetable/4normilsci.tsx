          ...
          <table className="table-auto border border-gray-300 min-w-full h-96">
            ...
            <tbody>
              <tr>
                ...
                <td colSpan={1} className="px-4 py-2 border border-gray-300 bg-yellow-200"></td>
                <td colSpan={1} className="px-4 py-2 border border-gray-300"></td>
                <td colSpan={1} className="px-4 py-2 border border-gray-300 bg-yellow-200 text-xs">อังคาร 7</td>
                <td colSpan={1} className="px-4 py-2 border border-gray-300"></td>
                <td colSpan={1} className="px-4 py-2 border border-gray-300 bg-yellow-200 text-xs">อังคาร 8</td>
                <td colSpan={1} className="px-4 py-2 border border-gray-300"></td>
                <td colSpan={1} className="px-4 py-2 border border-gray-300"></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td colSpan={2} className="px-4 py-2 border border-gray-300 bg-orange-200 text-xs">อังคาร 6</td>
                <td colSpan={1} className="px-4 py-2 border border-gray-300"></td>
                <td colSpan={1} className="px-4 py-2 border border-gray-300"></td>
                <td colSpan={1} className="px-4 py-2 border border-gray-300"></td>
                ...
                <td colSpan={1} className="px-4 py-2 border border-gray-300 bg-orange-200"></td>
                <td colSpan={1} className="px-4 py-2 border border-gray-300 bg-orange-200"></td>
                <td colSpan={1} className="px-4 py-2 border border-gray-300 bg-orange-200 text-xs">จันทร์ 6</td>
              </tr>
              <tr>
