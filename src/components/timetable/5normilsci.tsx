          ...
          <table className="table-auto border border-gray-300 min-w-full h-96">
            ...
            <tbody>
              <tr>
                ...
                <td colSpan={2} className="px-4 py-2 border border-gray-300 bg-yellow-200 text-xs">ศุกร์ 6</td>
              ...
              <tr>
                ...
                <td colSpan={2} className="px-4 py-2 border border-gray-300 bg-emerald-500"></td>
                <td colSpan={1} className="px-4 py-2 border border-gray-300 bg-emerald-500"></td>
                <td colSpan={1} className="px-4 py-2 border border-gray-300 bg-emerald-500"></td>
                <td colSpan={1} className="px-4 py-2 border border-gray-300 bg-emerald-500"></td>
                <td colSpan={1} className="px-4 py-2 border border-gray-300 bg-emerald-500"></td>
                <td colSpan={1} className="px-4 py-2 border border-gray-300 bg-emerald-500"></td>
              ...
              <tr>
                ...
                <td colSpan={1} className="px-4 py-2 border border-gray-300"></td>
                <td colSpan={1} className="px-4 py-2 border border-gray-300"></td>
                <td colSpan={1} className="px-4 py-2 border border-gray-300 bg-green-200 text-xs">อังคาร 3</td>
                <td colSpan={1} className="px-4 py-2 border border-gray-300 bg-green-200 text-xs">อังคาร 4</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td colSpan={2} className="px-4 py-2 border border-gray-300"></td>
                <td colSpan={1} className="px-4 py-2 border border-gray-300 bg-blue-200"></td>
                <td colSpan={1} className="px-4 py-2 border border-gray-300 bg-blue-200"></td>
                <td colSpan={1} className="px-4 py-2 border border-gray-300"></td>
                <td colSpan={1} className="px-4 py-2 border border-gray-300"></td>
                <td colSpan={1} className="px-4 py-2 border border-gray-300"></td>
                <td colSpan={1} className="px-4 py-2 border border-gray-300"></td>
                <td colSpan={1} className="px-4 py-2 border border-gray-300 bg-blue-200 text-xs">ศุกร์ 7</td>
                <td colSpan={1} className="px-4 py-2 border border-gray-300"></td>
                <td colSpan={1} className="px-4 py-2 border border-gray-300 bg-blue-200 text-xs">ศุกร์ 8</td>
                <td colSpan={1} className="px-4 py-2 border border-gray-300 bg-blue-200 text-xs">อังคาร 1</td>
                <td colSpan={1} className="px-4 py-2 border border-gray-300 bg-blue-200 text-xs">อังคาร 2</td>
              </tr>
            </tbody>
          </table>
        </div>
